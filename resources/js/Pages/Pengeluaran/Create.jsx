...
export default function PengeluaranCreate() {
    const { data, setData, post, processing } = useForm({ kategori: '', jumlah: '', keterangan: '', tanggal: new Date().toISOString().split('T')[0] });
    const submit = (e) => { e.preventDefault(); post(route('pengeluaran.store')); };
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="mb-6">
                ...
                <h1 className="text-2xl font-bold text-[#000000] mt-1">Catat Pengeluaran</h1>
            </div>
